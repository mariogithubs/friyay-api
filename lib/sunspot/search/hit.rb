module Sunspot
  module Search
    ...
    class Hit
      ...
      #
      # Tenant name of object associated with this hit, as string.
      #
      ...
      def initialize(raw_hit, highlights, search) #:nodoc:
        @tenant_name, @class_name, @primary_key = *raw_hit['id'].split(' ')
        @score = raw_hit['score']
        @search = search
      ...
      def stored(field_name, dynamic_field_name = nil)
        ...
        return @stored_cache[field_key] if @stored_cache.key?(field_key)
